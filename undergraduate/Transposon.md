...
- 转导细胞基因组序列：
	- 转导病毒 (transducing virus)：获得细胞部分序列的病毒变种
		- 复制缺陷型病毒 (replication-defective virus)
		- 辅助病毒 (helper virus)
	- 产生原因：病毒基因的缺失导致原病毒与*c-onc*基因融合，经转录产生联合RNA分子

## 反转录因子分类

反转录因子分三类：
- LTR retroTE (retrotransposon, 反转录转座子)：总体结构和转座机制与反转录原病毒高度相似，都具有LTR以及反转录酶和整合酶活性
	- 酵母基因组：*Ty*因子 (transposon yeast)
		- 类似反转录病毒，组织结构与内源性反转录病毒相似
	- 果蝇基因组：*copia*因子
	- 哺乳动物基因组：内源性的反转录病毒，可被激活
		- 人类基因组：内源性反转录病毒，～5000万年前几乎全部失活
	- 小鼠基因组：几种活性的内源性反转录病毒
- non-LTR retroTE (retroposon, 反转录子)：衍生自RNA聚合酶II的转录物
	- 自主性：
		- autonomous non-LTR retroTE：少部分
		- non-autonomous non-LTR retroTE：多数
	- 分类：
		- 人类基因组：长散在核元件 (long-interspersed nuclear element, LINE)
			- 编码：
				- 核酸结合蛋白
				- 具有反转录酶和内切核酸酶活性的蛋白质
			- 哺乳动物中最常见的LINE：L1，6000bp
- SINE (short-interspersed nuclear element, 短散在核元件)：总是非自主，源于细胞转录物的一类转座子之一，衍生自RNA pol III的转录物
	- 人类基因组：只有Alu元件 (Alu element) 有活性，来源于7SL RNA
